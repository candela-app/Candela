      ...
      >
        <ScrollView contentContainerStyle={{ paddingVertical: s(8) }}>
          <View style={{ backgroundColor: '#1A1A1A', borderRadius: s(24), borderWidth: 1, borderColor: '#374151', padding: s(18) }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: s(10), paddingTop: s(8) }}>
              <Pressable
                onPress={onClose}
                style={{
              ...
              >
                <Text style={{ color: '#0F172A', fontWeight: '800', fontSize: fs(13) }}>Apply</Text>
              </Pressable>
            </View>
          </View>
        </ScrollView>
